...
@section('page-subtitle', 'Layanan > Kelola Layanan > Tambah Layanan')
...
@section('content')
    ...
    <div class="mx-auto max-w-3xl space-y-6">
        ...
        <x-card padding="p-6">
            <x-slot:header>
                <h2 class="font-display text-base font-semibold text-pln-navy-900">Tambah Layanan Baru</h2>
            </x-slot:header>

            <form action="{{ route('admin.layanan.store') }}" method="POST" novalidate>
                @csrf
