...
@section('page-subtitle', 'Dashboard > Pengumuman > Ubah Pengumuman')
...
@section('content')
    ...
    <div class="mx-auto max-w-3xl space-y-6">
        ...
        <x-card padding="p-6">
            <x-slot:header>
                <h2 class="font-display text-base font-semibold text-pln-navy-900">Ubah Pengumuman: {{ $pengumuman->judul }}</h2>
            </x-slot:header>

            <form action="{{ route('admin.pengumuman.update', $pengumuman) }}" method="POST" novalidate>
                @csrf
                @method('PUT')

                <x-pengumuman.form :pengumuman="$pengumuman" />
