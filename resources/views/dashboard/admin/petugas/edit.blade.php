...
@section('page-subtitle', 'Dashboard > Pengguna > Ubah Petugas')
...
@section('content')
    ...
    <div class="mx-auto max-w-3xl space-y-6">
        ...
        <x-card padding="p-6">
            <x-slot:header>
                <h2 class="font-display text-base font-semibold text-pln-navy-900">Ubah Petugas: {{ $petugas->nama_petugas }}</h2>
            </x-slot:header>

            <form action="{{ route('admin.pengguna.update', $petugas) }}" method="POST" novalidate>
                @csrf
                @method('PUT')

                <x-petugas.form :petugas="$petugas" />
