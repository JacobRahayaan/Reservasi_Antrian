...
@php
    ...
    // @assumsi: nama route detail reservasi Customer Service, dibangun pada
    // sprint berikutnya (dilarang dibuat pada Sprint 4 ini). Tombol otomatis
    // aktif begitu route tersebut terdaftar, tanpa perlu ubah komponen ini.
...
<tr class="border-b border-pln-slate-100 last:border-0">
    ...
    <td class="px-4 py-3 text-sm font-medium text-pln-slate-900">{{ $reservasi->nama }}</td>
